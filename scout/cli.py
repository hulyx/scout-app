...
def mine(seed, depth, department):
    ...
    """
    from scout.keyword_engine import mine_keywords
...
def track_add(asin, name, own):
    ...
    from scout.collectors.product_scraper import CaptchaDetected
    from scout.collectors.bsr_model import sales_velocity_label
...
def import_ads(filepath, campaign):
    ...
    """
    from scout.collectors.ads_importer import AdsImporter
...
def trending(source, list_type, limit, save):
    ...
    """
    from scout.collectors.trending import (
...
def mine_categories(categories, depth, department, limit_categories):
    ...
    """
    from scout.collectors.trending import get_category_seeds
    from scout.keyword_engine import mine_keywords
...
from scout.cli_automation import automate, seeds, cron
